  ...
  return (
    <div>
      ...
      >
        ...
        {text ? (
          <text transform="matrix(1 0 0 1 351 355)">
            {/* eslint-disable-next-line react/prop-types */}
            {text.split("\n").map((t, i) => (
              <tspan x="0" y={31 * i} className="text_forgiveness" key={`text-${i}`}>
                {t}
              </tspan>
            ))}
          </text>
          ...
          <>
            ...
            <text transform="matrix(1 0 0 1 351 372)">
              <tspan x="0" y="0" className="text_forgiveness">
                code site
              </tspan>
              <tspan x="0" y="31" className="text_forgiveness">
                for food
              </tspan>
            </text>
          </>
